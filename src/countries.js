const fi = require('../node_modules/svg-country-flags/svg/fi.svg');
const gb = require('../node_modules/svg-country-flags/svg/gb.svg');
const de = require('../node_modules/svg-country-flags/svg/de.svg');
const es = require('../node_modules/svg-country-flags/svg/es.svg');
const jp = require('../node_modules/svg-country-flags/svg/jp.svg');
const lv = require('../node_modules/svg-country-flags/svg/lv.svg');
const pt = require('../node_modules/svg-country-flags/svg/pt.svg');
const se = require('../node_modules/svg-country-flags/svg/se.svg');
const us = require('../node_modules/svg-country-flags/svg/us.svg');
const fr = require('../node_modules/svg-country-flags/svg/fr.svg');
const ca = require('../node_modules/svg-country-flags/svg/ca.svg');
const at = require('../node_modules/svg-country-flags/svg/ca.svg');
const au = require('../node_modules/svg-country-flags/svg/ca.svg');

// TODO: Add language codes

class CountryData {
	constructor(name, demonym, iso2, iso3, altSpellings = [], flag = gb) {
		this.name = name;
...
const countries = [
	...
	new CountryData('Australia', 'Australian', 'AU', 'AUS', [], au),
	new CountryData('Austria', 'Austrian', 'AT', 'AUT', [], at),
	...
	new CountryData('Canada', 'Canadian', 'CA', 'CAN', [], ca),
	...
	new CountryData('Finland', 'Finnish', 'FI', 'FIN', [], fi),
	new CountryData('France', 'French', 'FR', 'FRA', [], fr),
	...
	new CountryData('Germany', 'German', 'DE', 'DEU', [], de),
	...
	new CountryData('Japan', 'Japanese', 'JP', 'JPN', [], jp),
	...
	new CountryData('Latvia', 'Latvian', 'LV', 'LVA', [], lv),
	...
	new CountryData('Portugal', 'Portuguese', 'PT', 'PRT', [], pt),
	...
	new CountryData('Spain', 'Spanish', 'ES', 'ESP', [], es),
	...
	new CountryData('Sweden', 'Swedish', 'SE', 'SWE', [], se),
	...
	new CountryData('United Kingdom', 'British', 'GB', 'GBR', ['UK'], gb),
	// new CountryData('United States Minor Outlying Islands', 'American Islander', 'UM', 'UMI'),
	new CountryData('United States', 'American', 'US', 'USA', ['USA'], us),
